...
INSERT INTO books_48 (book_id, name, available_from)
VALUES (1, 'Kalila And Demna', TO_DATE('2010-01-01', 'YYYY-MM-DD'));

INSERT INTO books_48(book_id, name, available_from)
VALUES (2, '28 Letters', TO_DATE('2012-05-12', 'YYYY-MM-DD'));

INSERT INTO books_48 (book_id, name, available_from)
VALUES (3, 'The Hobbit', TO_DATE('2019-06-10', 'YYYY-MM-DD'));

INSERT INTO books_48 (book_id, name, available_from)
VALUES (4, '13 Reasons Why', TO_DATE('2019-06-01', 'YYYY-MM-DD'));

INSERT INTO books_48 (book_id, name, available_from)
VALUES (5, 'The Hunger Games', TO_DATE('2008-09-21', 'YYYY-MM-DD'));
...
INSERT INTO Orders_48 (order_id, book_id, quantity, dispatch_date)
VALUES
  (1, 1, 5, TO_DATE('2019-05-10', 'YYYY-MM-DD')),
  (2, 2, 8, TO_DATE('2019-06-15', 'YYYY-MM-DD')),
  (3, 3, 12, TO_DATE('2019-03-20', 'YYYY-MM-DD')),
  (4, 4, 3, TO_DATE('2019-04-05', 'YYYY-MM-DD')),
  (5, 5, 2, TO_DATE('2019-05-30', 'YYYY-MM-DD'));
